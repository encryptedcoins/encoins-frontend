...
copy_main_8107() {
  cp "dist-newstyle/build/js-ghcjs/ghcjs-8.10.7/encoins-frontend-${1}/x/encoins-website/build/encoins-website/encoins-website.jsexe/all.js" "result/index.js"
}

copy_app_8107() {
  cp "dist-newstyle/build/js-ghcjs/ghcjs-8.10.7/encoins-frontend-${1}/x/encoins-app/build/encoins-app/encoins-app.jsexe/all.js" "result/app.js"
}

copy_dao_8107() {
  cp "dist-newstyle/build/js-ghcjs/ghcjs-8.10.7/encoins-frontend-${1}/x/encoins-dao/build/encoins-dao/encoins-dao.jsexe/all.js" "result/dao.js"
}
...
copy_js_8107() {
  printf '\n\n==== Copy js files to result ===='
  if ! copy_main_8107 "$1"; then
    printf "\n\nCoping main page is failed."
  else
    if ! copy_app_8107 "$1"; then
      printf "\n\nCoping app is failed"
    else
