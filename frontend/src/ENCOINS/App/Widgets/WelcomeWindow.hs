...
wImportExport :: Text
wImportExport = [r|All known coins are stored locally on your device. Here, you can import the coins that are new to this device. You can also export your coins for backup or use on another device.|]
