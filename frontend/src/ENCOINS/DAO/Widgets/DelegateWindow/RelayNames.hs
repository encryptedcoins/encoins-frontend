...
relayNames = fromList
  [
    ...
    -- Add here new urls
    ("73.23.36.140", "PetLoverStake"),
    ("61.77.248.249", "KTOP SPO"),
    ("128.199.195.27", "Waffle"),
    ("136.243.152.100", "[CHIL] Chile Stake pool"),
    ("encoins.bladepool.com", "BLADE"),
    ("146.190.63.130", "Peter Bui"),
    ("5.189.164.41", "SUDTI Pool"),
    ("82.165.230.141", "OYSTR"),
    ("146.190.34.49", "LABA-RELAY"),
    ("encoins-relay.cardanistas.io", "Cardanistas Stake Pool"),
    ("encoins.reservoir.network", "BURN pool"),
    ("213.136.92.202", "Toby Relay"),
    ("167.71.10.20", "zencs-relay"),
    ("38.242.237.17", "cardano.uno"),
    ("161.97.73.124", "SafeStride relay"),
    ("encs.chunkymonkey.us", "Chunky Monkey"),
    ("142.132.189.114", "KTOP SPO 2"),
    ("161.97.172.86", "PetLoverStake-II"),
    ("135.148.53.149", "Vortex Relay"),
    ("135.148.53.148", "Panda Relay"),
    ("125.250.255.197", "KTOP SPO 3"),
    ("encoins-maria-relay.cardanistas.io", "Maria Carmo 369"),
    ("95.179.167.197", "Maria Carmo 369"),
    ("2.59.156.182", "Toby 3 Relay"),
    ("81.56.175.1", "SUDTI Pool 3"),
    ("144.91.80.26", "Toby 2 Relay"),
    ("encoins02.bladepool.com", "BLADE02"),
    ("75.119.155.25", "SUDTI Pool 2"),
    ("117.50.199.89", "BAIDU"),
    ("172.205.248.34", "Waffle #2"),
    ("135.148.53.151", "Prism Relay"),
    ("161.97.88.36", "RUMOR"),
    ("136.244.19.126", "Cipher Relay"),
    ("23.105.171.80", "DC Private"),
    ("178.119.158.164", "KTOP SPO 4"),
    ("encoins.cardanode.com.au", "ADAOZ"),
    ("encoins.congeepool.com", "[CONGE] Conge Pool"),
    ("154.38.171.77", "Toby 4 Relay"),
    ("149.102.156.213", "Toby 5 Relay (Private)"),
    ("176.57.184.115", "Toby 6 Relay"),

    -- Legacy names. Left for back compatibility
    -- Don't add urls here.
