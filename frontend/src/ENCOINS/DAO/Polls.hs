...
poll6 n voteRes voteFullRes =
    Poll
        n
        ( text $
            pollNum n
                <> "Do you approve performing a Collective Zap-In from the treasury for a total of 150k $ADA, including rewards?"
        )
        ( do
            text
...
poll5 n voteRes voteFullRes =
    Poll
        n
        ( text $
            pollNum n
                <> "Do you approve the Treasury Allocation and Sustainable Development Plan proposed by the ENCOINS team?"
        )
        ( do
            text
                "The complete Treasury Allocation Plan was proposed recently by the ENCOINS team on "
            lnkInline
                "https://discord.com/channels/930855339501445151/1144309678352900134/1144309678352900134"
                "Discord"
            text
                ". The plan sets specific amounts for spending on audits, bug bounty program, liquidity provision, and team incentives. \
...
poll4 n voteRes voteFullRes =
    Poll
        n
        ( text $
            pollNum n <> "Spend up to 100k $ENCS from the treasury on the VyFi partnership?"
        )
        ( do
            ...
            br
            text
                "The amount of $ENCS starts at low quantities and increase as liquidity increases. With 70,000 $ENCS we will have enough \
            ...
            br
            text
                "This program aims to compensate our holders. It will end when the available tokens are distributed, or when the protocol \
            ...
            lnkInline
                "https://discord.com/channels/930855339501445151/1136310556026994748"
                "Discord server"
            text "."
        )
        voteRes
...
poll3 n voteRes voteFullRes =
    Poll
        n
        ( text $
            pollNum n
                <> "Spend 250k $ENCS from the treasury on the ENCOINS v1 protocol audit?"
        )
        ( do
            text
            ...
            lnkInline
                "https://discord.com/channels/930855339501445151/1120801429112762448"
                "Discord server"
            text "."
        )
        voteRes
...
poll2 n voteRes voteFullRes =
    Poll
        n
        ( text $
            pollNum n
                <> "Spend 50k $ENCS from the treasury as rewards for incentivized farming on MinSwap?"
        )
        ( do
            text
            ...
            lnkInline
                "https://docs.minswap.org/faq/token-launching-and-farming/4.-farming-for-projects"
                "here"
            text
                "). \
...
poll1 n voteRes voteFullRes =
    Poll
        n
        ( text $
            pollNum n
                <> "Do you support the proposal to use 50k $ENCS from the treasury to provide liquidity to the $ENCS/$ADA pool on MinSwap?"
        )
        ( text
