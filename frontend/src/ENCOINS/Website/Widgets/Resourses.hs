...
resourseButton cls lnk file w =
    divClass "div-image-large" $
        elAttr
            "a"
            ("href" =: lnk <> "target" =: "_blank" <> "class" =: "link w-inline-block") $
            void $
...
ourResourses w = do
    ...
    resourseButton
        ""
        "https://www.youtube.com/channel/UCk4QtReP4kQKfIIoWw7Q1wg"
        "YouTube.svg"
        w
